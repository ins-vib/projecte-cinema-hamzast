...
public class SecurityConfig {
    ...
    .requestMatchers("/screening/**").hasRole("ADMIN")
    .requestMatchers("/screenings/**").hasRole("ADMIN")
    .requestMatchers("/pelicula/**").hasRole("ADMIN")
    .requestMatchers("/room/**").hasRole("ADMIN")
    .requestMatchers("/seat/**").hasRole("ADMIN")
    .requestMatchers("/contacte").hasRole("ADMIN")
